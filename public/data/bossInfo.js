// public/data/bossInfo.js
// Extra info for bosses, same style as charactersInfo.js

const bossInfo = {
  "Iudex Gundyr": {
    imgs: ["/images/bosses/gundyr.jpg"],
  ...
  "Curse-Rotted Greatwood": {
    imgs: ["/images/bosses/curse.jpg"],
    text: "This massive, diseased tree houses the curses of countless souls. Its fight revolves around striking pus-filled sacs across its body, leading to grotesque transformations. The Greatwood is highly resistant to most damage types except strike and fire, which shatter its weak points and burn through its defenses."
  },
  "Crystal Sage": {
    imgs: ["/images/bosses/crystal.jpg"],
    text: "A master sorcerer draped in flowing robes, the Crystal Sage bombards challengers with soul sorceries and conjured illusions. It resists magic damage but is vulnerable to physical strikes, particularly melee weapons that can pressure it before it teleports. Fire and lightning spells are also effective counters."
  },
  "Deacons of the Deep": {
    imgs: ["/images/bosses/deacon.jpg"],
  ...
  "High Lord Wolnir": {
    imgs: ["/images/bosses/lord.jpg"],
    text: "Once a conquering monarch, Wolnir now lingers as a colossal skeleton wrapped in cursed bracelets. He resists most physical and elemental attacks, but his weakness lies in his glowing bracelets—destroy them to drag him into the abyss."
  },
  "Old Demon King": {
    imgs: ["/images/bosses/demon-king.jpg"],
  ...
  "Yhorm the Giant": {
    imgs: ["/images/bosses/yhorm.jpg"],
    text: "Once a benevolent giant who became a Lord of Cinder, Yhorm can only be meaningfully felled using the Storm Ruler, a sword placed within his arena. Standard weapons deal little to him, as his immense size grants natural resistance."
  },
  "Aldrich, Devourer of Gods": {
    imgs: ["/images/bosses/aldrich.jpg"],
  ...
  "Lothric and Lorian": {
    imgs: ["/images/bosses/twin.jpg"],
    text: "The twin princes embody the fading line of royalty. Lorian, crippled by curse, carries his younger brother Lothric into battle. They resist fire and dark but are weak to lightning."
  },
  "Ancient Wyvern": {
    imgs: ["/images/bosses/wyvern.jpg"],
  ...
  "Nameless King": {
    imgs: ["/images/bosses/nameless.jpg"],
    text: "A forgotten deity of war and storms, the Nameless King was cast out for allying with dragons. He resists lightning, befitting his stormy powers, but is weak to fire and frost."
  },
  "Soul of Cinder": {
    imgs: ["/images/bosses/soul.jpg"],
    text: "The final boss embodies all who linked the fire, shifting between fighting styles of previous heroes. He resists most elements equally, but lightning and frost have slight advantages."
  },

  // DLC bosses
  "Champion's Gravetender & Greatwolf": {
    imgs: ["/images/bosses/grave.jpg"],
    text: "The Gravetender and his loyal wolf guard a forgotten tomb. The Gravetender is a skilled swordsman, while the Greatwolf grows more ferocious as the fight progresses. They resist frost but are weak to lightning and fire."
  },
  "Sister Friede": {
    imgs: ["/images/bosses/sister.jpg"],
    text: "The eldest of the Sable Church’s daughters, Friede conceals her ambition beneath cold restraint. She resists frost and magic but is weak to fire and lightning. Her three-phase battle tests endurance and adaptability."
  },
  "Demon Prince": {
    imgs: ["/images/bosses/prince.jpg"],
  ...
  "Slave Knight Gael": {
    imgs: ["/images/bosses/gael.jpg"],
    text: "Gael, once humble, seeks the Dark Soul of Humanity to complete a painter’s vision. His long, grueling fight grows more frenzied as he absorbs the Dark Soul’s power. He resists bleed and poison but is weak to strike damage and lightning."
  }
};
